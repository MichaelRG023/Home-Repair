...
function ProfessionalServices(){
    ...
    return(
        ...
        <div className="bg-gray-300">
           ...
           <ul className="w-6/12 text-sm font-medium text-gray-900 bg-amber-600  dark:bg-gray-700 dark:border-gray-600 dark:text-white ">
        ...
        <button className=" h-11 w-48 outline outline-2 text-lg ">Contact Us</button>
    </div>
    )
}
