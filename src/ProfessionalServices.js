...
function ProfessionalServices(){
    ...
    return(
        ...
        <div className="bg-gray-300">
           ...
           <img className="h-full"src="https://le-cdn.hibuwebsites.com/64b7818a0493479cbd6724b436d6f79f/dms3rep/multi/opt/694903-1152w.jpg" alt="wrench being held" />
           <ul className="w-48 text-sm font-medium text-gray-900 bg-amber-600  dark:bg-gray-700 dark:border-gray-600 dark:text-white">
             <li className=" w-xl  border-gray-200 rounded-t-lg dark:border-gray-600">
               <div className="flex items-center ps-3">
                   <input id="vue-checkbox" type="checkbox" value="" className="w-11 h-20 text-blue-600 bg-gray-100"></input>
           ...
           <li className="w-lg  border-gray-200 rounded-t-lg dark:border-gray-600">
               <div className="flex items-center ps-3">
                    <input id="vue-checkbox" type="checkbox" value=""className="w-9 h-20 text-blue-600 bg-gray-100"></input>
           ...
           <li className="w-lg  border-gray-200 rounded-t-lg dark:border-gray-600">
               <div className="flex items-center ps-3">
                   <input id="vue-checkbox" type="checkbox" value=""className="w-7 h-20 text-blue-600 bg-gray-100"></input>
        ...
        <button className=" h-12 w-48 outline outline-2 text-lg ">Contact Us</button>
    </div>
    )
}
